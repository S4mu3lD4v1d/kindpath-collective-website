  ...
  return (
    <main className="bg-sand">
      <section className="max-w-6xl mx-auto px-4 pt-14 pb-16 text-center">
        ...
        <h1 className="mt-6 text-4xl leading-tight font-semibold text-primary md:text-5xl md:leading-snug">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 md:flex-row">
          <a
            href="/join-pilot"
            className="rounded-full bg-amber px-5 py-3 text-sm font-semibold text-white shadow-soft transition hover:bg-primary-dark"
          >
            Join the Pilot
          </a>
          <a
            href="/platform"
            className="rounded-full border border-primary/30 px-5 py-3 text-sm font-semibold text-primary transition hover:border-primary hover:text-primary-dark"
          >
            View the Platform
          </a>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-14 text-center">
        ...
        <div className="mt-6 flex justify-center">
          <a
            href="/join-pilot"
            className="rounded-full bg-amber px-6 py-3 text-sm font-semibold text-white shadow-soft transition hover:bg-primary-dark"
          >
