    ...
    <main className="bg-sand">
      <div className="max-w-3xl mx-auto px-4 py-14 space-y-10">
        ...
        <section className="card p-8">
          ...
          <p className="mt-2 mb-6 text-sm text-slate-600">Tell us a bit about yourself and what you&apos;re looking for.</p>
          <form className="space-y-4">
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Name</label>
              <input type="text" className="w-full rounded-lg border border-[#dfeae7] bg-white px-3 py-2 focus:border-primary focus:outline-none" />
            </div>
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Email</label>
              <input type="email" className="w-full rounded-lg border border-[#dfeae7] bg-white px-3 py-2 focus:border-primary focus:outline-none" />
            </div>
            <div>
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">I am interested in...</label>
              <select className="w-full rounded-lg border border-[#dfeae7] bg-white px-3 py-2 focus:border-primary focus:outline-none">
            ...
            <div>
              ...
              <textarea className="w-full rounded-lg border border-[#dfeae7] bg-white px-3 py-2 focus:border-primary focus:outline-none" rows={4}></textarea>
            </div>
            <button
              type="submit"
