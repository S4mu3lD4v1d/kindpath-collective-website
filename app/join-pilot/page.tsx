    ...
    <main>
      <div className="max-w-3xl mx-auto px-4 py-14 space-y-10">
        <header className="text-center space-y-3">
          ...
          <h1 className="text-4xl font-semibold text-[color:var(--kp-moss)]">Join the Pilot</h1>
        ...
        <section className="card p-8">
          <h2 className="text-2xl font-semibold text-[color:var(--kp-moss)]">Expression of Interest</h2>
          ...
          <form className="space-y-4">
            <div>
              ...
              <input type="text" className="w-full rounded-lg border border-[color:var(--kp-cloud)] bg-white px-3 py-2 focus:border-[color:var(--kp-moss)] focus:outline-none" />
            </div>
            <div>
              <label className="block text-sm font-semibold text-[color:var(--kp-slate-700)] mb-1">Email</label>
              <input type="email" className="w-full rounded-lg border border-[color:var(--kp-cloud)] bg-white px-3 py-2 focus:border-[color:var(--kp-moss)] focus:outline-none" />
            </div>
            <div>
            ...
            <div>
              ...
              <select className="w-full rounded-lg border border-[color:var(--kp-cloud)] bg-white px-3 py-2 focus:border-[color:var(--kp-moss)] focus:outline-none">
            ...
            <div>
              ...
              <textarea className="w-full rounded-lg border border-[color:var(--kp-cloud)] bg-white px-3 py-2 focus:border-[color:var(--kp-moss)] focus:outline-none" rows={4}></textarea>
            </div>
            <button
              type="submit"
